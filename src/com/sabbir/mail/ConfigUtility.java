...
public class ConfigUtility {
	...
	public Properties loadProperties() throws IOException {
		...
		defaultProps.setProperty("mail.smtp.host", "smtp.qq.com");
		defaultProps.setProperty("mail.smtp.port", "587");
		defaultProps.setProperty("mail.user", "watcher.hangzhou@foxmail.com");
		defaultProps.setProperty("mail.password", "YOUR_PASSWORD");
